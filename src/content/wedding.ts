...
const weddingImages = {
  ...
  three: new URL('../features/gallery/images/3.webp', import.meta.url).href,
  four: new URL('../features/gallery/images/4.webp', import.meta.url).href,
  five: new URL('../features/gallery/images/5.webp', import.meta.url).href,
  six: new URL('../features/gallery/images/6.webp', import.meta.url).href,
